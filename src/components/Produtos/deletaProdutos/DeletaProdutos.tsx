...
function DeletarProduto() {
  ...
  return (
    ...
    <div className='container flex flex-col  mx-auto'>
        ...
        <h1 className=' text-2xl md:text-4xl text-center my-4 p-10'>Deletar Produto</h1>
        <p className='text-center text-xl p-4 font-semibold mb-4'>Você tem certeza de que deseja apagar o Produto a seguir?</p>

    
    <div className="flex flex-col  justify-center container mx-auto">
    <div className="container flex  flex-col mx-auto md:w-1/3">
    ...
    <div className='grid text-center my-16 gap-4  mx-auto container   rounded-3xl shadow-2xl'>
      <div className='bg-white flex flex-col  rounded-3xl  h-full relative'>
        ...
        <div className='w-full h-60  '>
          ...
          <div className='gap-4 flex flex-col p-10 items-center justify-center h-full'>
      ...
      <div className="flex mb-10 px-10 gap-9">
